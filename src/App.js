...
const EnhancedSignupForm = lazy(() => import('./components/EnhancedSignupForm'));
const EnhancedStylishLoginForm = lazy(() => import('./components/EnhancedStylishLoginForm'));
      ...
      <Router>
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            <Route path="/login" element={<EnhancedStylishLoginForm />} />
            <Route path="/create-account" element={<EnhancedSignupForm />} />
